...
Tests Qwen3.6-27B-IQ4_NL on port 8081.
"""
    ...
    try:
        ...
        for line in resp:
            ...
            try:
                ...
                # Check both content and reasoning_content (for thinking mode)
...
def main():
    print("=" * 80)
    print("llama-bench style testing (streaming) - Qwen3.6-27B-IQ4_NL - Thinking ON")
    print(f"Model: {MODEL}")
    ...
    # Save results
    with open("bench_stream_qwen36_27b_results.json", "w") as f:
        json.dump(results, f, indent=2)
    print("\nResults: bench_stream_qwen36_27b_results.json")
